...
# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy20_inversion.recode.vcf")
...
write.csv(pca_df, "PCA_Omy20_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy20_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy20_interspecific_Interactive_3D.html")