...
## OMY01 RANDOM
## Omy01 12 Mb to 42 Mb

#### PCA from VCF and popmap ####

# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy01_Random.recode.vcf")
...
write.csv(pca_df, "PCA_Omy01_Random_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy01_Random_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy01_Random_Interactive_3D.html")
...
# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy14_Random.recode.vcf")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy14_Random_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy14_Random_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy14_Random_Interactive_3D.html")

## OMY18 RANDOM
## Omy18 31 Mb to 39 Mb

#### PCA from VCF and popmap ####

# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy18_Random.recode.vcf")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy18_Random_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy18_Random_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy18_Random_Interactive_3D.html")
