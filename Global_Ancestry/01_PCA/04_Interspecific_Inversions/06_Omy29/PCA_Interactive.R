...
# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy29_inversion1.recode.vcf")
...
popmap <- read.table("../00_input_vcfs/popmap_subset.txt", header = FALSE, stringsAsFactors = FALSE)
...
p <- ggplot(pca_df, aes(x = Axis1, y = Axis2, color = population)) +
  ...
  theme_classic() +
  labs(title = "Omy05 Interspecific",
...
write.csv(pca_df, "PCA_Omy29_1_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy29_1_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy29_1_interspecific_Interactive_3D.html")
...
# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy29_inversion2.recode.vcf")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy29_2_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy29_2_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy29_2_interspecific_Interactive_3D.html")

## First Inversion - FULL

#### PCA from VCF and popmap ####

# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy29_inversion_full.recode.vcf")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy29_full_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy29_full_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy29_full_interspecific_Interactive_3D.html")

## INVERSION 3 - UPSTREAM

#### PCA from VCF and popmap ####

# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy29_inversion3.recode.vcf")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy29_3_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy29_3_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy29_3_interspecific_Interactive_3D.html")