...
p <- ggplot(pca_df, aes(x = Axis1, y = Axis2, color = population)) +
  ...
  theme_classic() +
  labs(title = "Omy05 Inversion 1 Interspecific",
...
write.csv(pca_df, "PCA_Omy05_1_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy05_1_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy05_1_interspecific_Interactive_3D.html")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy05_2_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy05_2_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy05_2_interspecific_Interactive_3D.html")

## Full Inversion Complex
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy05_full_interspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy05_full_interspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy05_full_interspecific_Interactive_3D.html")