...
# Read the VCF file
vcf <- read.vcfR("Omy13_99.9_RBT.recode.vcf")
...
popmap <- read.table("popmap_RBT_99.9.txt", header = FALSE, stringsAsFactors = FALSE)
...
write.csv(pca_df, "PCA_RBT_Omy13_Inversion_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_RBT_Omy13_Inversion_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_RBT_Omy13_Inversion_Interactive_3D.html")