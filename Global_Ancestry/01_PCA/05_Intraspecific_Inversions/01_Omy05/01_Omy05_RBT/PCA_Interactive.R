...
## Omy05 INVERSION 1 RBT

#### PCA from VCF and popmap ####

# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy05_inversion1.recode.vcf")
...
write.csv(pca_df, "PCA_Omy05_1_intraspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy05_1_intraspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy05_1_intraspecific_Interactive_3D.html")

## Omy05 INVERSION 2 RBT

#### PCA from VCF and popmap ####

# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy05_inversion2.recode.vcf")
...
p <- ggplot(pca_df, aes(x = Axis1, y = Axis2, color = population)) +
  ...
  scale_color_manual(values = pop_colors) +
  theme_classic() +
  labs(title = "Omy05 Intraspecific 2",
       x = paste0("PC1 (", percent_variation[1], "%)"),
       y = paste0("PC2 (", percent_variation[2], "%)"),
       color = "Population") +
  theme(legend.position = "right")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy05_2_intraspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy05_2_intraspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy05_2_intraspecific_Interactive_3D.html")

## Omy05 INVERSION FULL RBT

#### PCA from VCF and popmap ####

# Read the VCF file
vcf <- read.vcfR("../00_input_vcfs/Omy05_inversion_full.recode.vcf")
...
# Save PCA coordinates
write.csv(pca_df, "PCA_Omy05_full_intraspecific_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_Omy05_full_intraspecific_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_Omy05_full_intraspecific_Interactive_3D.html")
