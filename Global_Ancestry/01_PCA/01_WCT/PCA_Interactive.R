...
# Read the VCF file
vcf <- read.vcfR("WCT_v_CRT.recode.vcf")
...
popmap <- read.table("popmap_WCT_v_CRT.txt", header = FALSE, stringsAsFactors = FALSE)
...
write.csv(pca_df, "PCA_WCT_coordinates.csv", row.names = FALSE)
...
# Save 2D plot
saveWidget(p_interactive_2D, file = "PCA_WCT_Interactive_2D.html")
...
# Save 3D plot
saveWidget(p_interactive_3D, file = "PCA_WCT_Interactive_3D.html")